...
brows_sync() {
  ...
  cd $PATH_DS
  browser-sync start --proxy 'https://web.develop.danskespil.dk' --files './Website/BuildArtifacts/Components/DanskeSpil/**/*.css' './Website/Views/**/*.cshtml' './Website/BuildArtifacts/Components/DanskeSpil/**/*.js' './Website/BuildArtifacts/Components/Shared/Framework/Ensighten/**/*.js' --no-notify --open external --no-ghost-mode --no-ui
}
alias bs='brows_sync'
...
# Hours
alias timelog='ds;echo " Hours:"; git log --committer=cajo@danskespil.dk --since="1 week ago" --all --no-merges --date=format:"%a %d/%m %H:%M" --pretty=format:"%<(20) %ad %s" ; echo ; cd -'
alias hours='timelog'
...
alias gw-bingo='node ./node_modules/gulp/bin/gulp.js --color && node ./node_modules/gulp/bin/gulp.js --color watch --theme Bingo'
alias gw-casino='node ./node_modules/gulp/bin/gulp.js --color && node ./node_modules/gulp/bin/gulp.js --color watch --theme Casino'
alias gw-danskespil='node ./node_modules/gulp/bin/gulp.js --color && node ./node_modules/gulp/bin/gulp.js --color watch --theme DanskeSpil'
alias gw-spillehjoernet='node ./node_modules/gulp/bin/gulp.js --color && node ./node_modules/gulp/bin/gulp.js --color watch --theme Spillehjoernet'
